/*
	Rollup.js v0.24.1
	Sat Jan 09 2016 09:38:14 GMT-0500 (EST) - commit 8b68d1ce90b30b00154c291e30a16ab22a1096ff
...
pp$3.toAssignable = function (node, isBinding) {
...
pp$3.parseRest = function (allowNonIdent) {
  var node = this.startNode();
  this.next();
...
pp$3.parseBindingList = function (close, allowEmpty, allowTrailingComma, allowNonIdent) {
  var elts = [],
      first = true;
...
pp$3.checkLVal = function (expr, isBinding, checkClashes) {
  switch (expr.type) {
    case "Identifier":
...
var Module = (function () {
		...
		this.statements.forEach(function (statement) {
			...
			if (statement.isExportDeclaration) {
				...
				if (statement.node.type === 'ExportNamedDeclaration' && statement.node.declaration.type === 'VariableDeclaration') {
					...
					var declaration = _this9.declarations[_name2];
	...
	Module.prototype.run = function run(safe) {
		...
		this.statements.forEach(function (statement) {
			marked = statement.run(_this10.strongDependencies, safe) || marked;
		});
